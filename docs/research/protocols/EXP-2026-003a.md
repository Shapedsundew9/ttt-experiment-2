...
- **Date**: 2026-09-06
- **Target Execution Directory**: `python/experiments/exp_2026_003a_swar_alu/`
...
- **Target Directory**: `python/experiments/exp_2026_003a_swar_alu/`
- **Package Module Path**: `python.experiments.exp_2026_003a_swar_alu`
- **Parent Lineage**: `python/experiments/exp_2026_002a_ply_mealy/`
- **Directory Layout**:

```text
python/experiments/exp_2026_003a_swar_alu/
├── __init__.py
├── config.toml
├── config.py
├── swar_engine.py
